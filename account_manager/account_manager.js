...
module.exports.logIn = async (username, password) =>
{
    ...
    if (USERNAME_REGEX.test(username) === false)
    {
        ...
        return Promise.reject(new Error(`The username must be between 3 and 50 characters long and can only contain letters, numbers or underscores.`));
    }
...
module.exports.signUp = async (username, password) =>
{
    ...
    if (PASSWORD_REGEX.test(password) === false)
    {
        ...
        return Promise.reject(new Error(`The password must be between 3 and 50 characters long and can contain letters or numbers, as well as at least one special character among the following: !@#$%&*-_`));
    }
