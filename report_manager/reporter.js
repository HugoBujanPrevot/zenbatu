...
/**
 * This module takes care of generating reports on a user's assets.
 * It does so by communicating with the DB Operations module to
 * fetch the data itself, and then going through that data to
 * find whatever needs reporting, like asset lifecycles or due
 * maintenances.
 */
...
// Helper constants to create the report, useful to
// do the operations related to millisecond timestamps
...
module.exports.generateReport = async function (username) {
    try {
        // Fetch all asset data for the username
        const assets = await dbOperations.getFullAssets(username);
        const report = [];

        // Iterate through each asset and create a report object
        assets.forEach((asset) => {
            // Use both the regular asset data and the new data
